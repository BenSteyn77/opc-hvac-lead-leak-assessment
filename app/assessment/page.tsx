      ...
      {isResults && (
        <section className="results">
          ...
          <div className="result-grid">
            ...
            <aside className="cta-card"><span>Want a second set of eyes?</span><h3>Complete Business Assessment</h3><p>We review lead handling, marketing, sales, operations, reporting and practical AI opportunities—then show you what to address first.</p><div className="price"><strong>$370</strong><s>Standard scope $2,000</s></div><a href="https://omniprocessconsulting.com/business-assessment.html" target="_blank" rel="noreferrer">Apply for your assessment <span>→</span></a></aside>
          </div>
